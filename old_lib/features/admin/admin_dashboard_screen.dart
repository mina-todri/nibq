...
class AdminDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'لوحة تحكم المدير'),
      body: analyticsAsync.when(
        ...
        data: (stats) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('نظرة عامة', style: AppTextStyles.displayLg),
              ...
              Text('إجراءات سريعة', style: AppTextStyles.displayLg),
              const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: color.withOpacity(0.04), blurRadius: 15, offset: const Offset(0, 4))],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Column(
            ...
            children: [
              FittedBox(
                ...
                child: Text(value, style: AppTextStyles.displayXl.copyWith(color: AppColors.textPrimary, height: 1.0)),
              ),
              const SizedBox(height: 4),
              Text(title, style: AppTextStyles.bodySm.copyWith(color: AppColors.textSecondary, fontWeight: FontWeight.w500)),
            ],
          ),
        ],
      ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(title, style: AppTextStyles.bodyMd.copyWith(fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                const SizedBox(height: 4),
                Text(subtitle, style: AppTextStyles.bodySm.copyWith(color: AppColors.textTertiary), textAlign: TextAlign.center),
              ],
            ),
          ),
          if (badgeCount > 0)
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: badgeColor.withOpacity(0.4), blurRadius: 8, offset: const Offset(0, 2))]
                ),
                child: Center(
                  child: Text(
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('منحنى المبيعات (آخر 7 أيام)', style: AppTextStyles.bodyMd.copyWith(fontWeight: FontWeight.bold)),
          ),
          Expanded(
                  ...
                  LineChartData(
                        ...
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            return Padding(
                              ...
                              child: Text(DateFormat('E', 'ar').format(date),
                                  style: AppTextStyles.bodyXs.copyWith(color: AppColors.textSecondary, fontSize: 10)),
                            );
                          },
                        ),
                      ),
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        ...
                        belowBarData: BarAreaData(show: true, color: AppColors.gold400.withOpacity(0.1)),
                      ),
                    ],
                    minY: 0, maxY: maxY,
                  ),
